...
def translate_word_document(input_file, output_file):
    ...
    # os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = '/D/Code/pyCode/Google/transppt-387002-02bdddaec806.json'
    # set GOOGLE_APPLICATION_CREDENTIALS=D:\Code\pyCode\Google\transppt\transppt-387002-02bdddaec806.json
    ...
    # 创建翻译请求
    parent = "projects/transppt-387002/locations/global"
    target_language = "en"
    model = "projects/transppt-387002/locations/global/models/general/nmt"
    maxtext = 500
    looptime = 0
